...
program
  ...
  .action(async (method) => {
    ...
    try {
      ...
      console.log(chalk.red("❌ Error creating DID:"), error);
    }
  });
...
program
  ...
  .action(async (did) => {
    try {
      ...
      console.log(chalk.red("❌ Error importing DID:"), error);
    }
  });
...
program
  ...
  .action(async (did) => {
    try {
      ...
      console.log(chalk.red("❌ Error setting primary DID:"), error);
    }
  });
...
program
  ...
  .action(async () => {
    try {
      ...
      console.log(chalk.red("❌ Error retrieving primary DID:"), error);
    }
  });
...
program
  ...
  .action(async (didString) => {
    let did = await userStore.getDID(didString);
    if (!did) {
...
program
  ...
  .action(async (subject) => {
    try {
      ...
      console.log(chalk.red("❌ Error signing VC:"), error);
    }
  });
...
program
  ...
  .action(async (vc) => {
    try {
      ...
      console.log(chalk.red("❌ Error verifying VC:"), error);
    }
  });
  ...
  .action(async (did) => {
    try {
      ...
      if(!did){
        ...
        let didObj = await userStore.getDID(did);
        if(!didObj){
      ...
      console.log(chalk.red("❌ Error retrieving recovery phrase:"), error);
    }
});
...
program
  ...
  .action(async (did, message) => {
    try {
      ...
      console.log(chalk.red("❌ Error encrypting data:"), error);
    }
  });
...
program
  ...
  .action(async () => {
    ...
    const metadata = await getEnvironmentMetadata(packageJsonPath);
